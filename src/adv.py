...
persona = {
    'Arsene': Persona( 'Arsene', 'Fire', 10, 20, 'Earth', 'Water', 'assets/Arsene.wav', 'assets/sounds/ArSkill.wav')
}


battleSound = ['assets/takeThis.wav', 'assets/itsOver.wav', 'assets/gotYou.wav', 'assets/die.wav', 'assets/fall.wav', 'assets/giveItUp.wav', 'assets/gotEm.wav']
battleStart = ['assets/battle1.wav','assets/battle2.wav','assets/battle3.wav']
hitSound = ['assets/bash.wav','assets/hit.wav','assets/slash.wav','assets/stab.wav']
...
playsound('assets/cantBe.wav')
time.sleep(1)
playsound('assets/notHere.wav')
time.sleep(1)
playsound('assets/stillFight.wav')
time.sleep(1)
...
input(f"{'Now choose Arsene by inputing: [a] Arsene... ':>230}\n")
...
if player.hp <= 0:
    winsound.PlaySound('assets/songs/gameOver.wav', winsound.SND_ASYNC)
    clear()
    pad()
